...
class Solution:
    ...
    # Complexity
    # Time complexity: ( O(n * m) ), where ( n ) is the length of the string and ( m )
    # is the maximum length of a word in the dictionary.
    # Space complexity: ( O(n) )
...
def test_merge(s, word_dict, expected_output):
    ...
    output = solution.wordBreak3(s, word_dict)
